...
<script type="text/javascript">
  ...
  $(function() {
    dataGrid = $('#dataGrid')
        .datagrid(
            {
              url : '${pageContext.request.contextPath}/lebi/rechargedetail/rechargedetailquery',
  ...
  function exportExcel() {
		...
		var url = '${pageContext.request.contextPath}/lebi/rechargedetail/excel?createtimestart='
