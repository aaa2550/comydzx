...
<script type="text/javascript">
  ...
  $(function() {
    dataGrid = $('#dataGrid')
        .datagrid(
            {
              url : '${pageContext.request.contextPath}/lebi/rechargedetail/rechargedetailquerysum',
  ...
  function loadsum() {
		...
		var url = "/lebi/rechargedetail/rechargedetailquerycount";
  ...
  function rechargefun(userid) {
      ...
      parent.iframeTab.init({url:'/lebi/rechargedetail/listdialog?userid=' + userid,text:'${internationalConfig.充值明细}'});
 }
	    
   function tradefun(userid,lbtype) {

     parent.iframeTab.init({url:'/lebi/tradedetail/listdialog?userid=' + userid+'&lbtype='+lbtype,text:'${internationalConfig.乐币明细}'});
   }  
</script>
</head>
<body>
    ...
    <div >
	    ...
	    <table class="table-more">
	        <tr>
	            ...
	            <td>
                    ${internationalConfig.充值总金额}：<b id="sumprice">0</b>
	            </td>
	            <td>
