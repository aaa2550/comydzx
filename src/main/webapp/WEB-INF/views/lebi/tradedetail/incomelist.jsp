...
<script type="text/javascript">
  ...
  function exportExcel() {
		...
		var url = '${pageContext.request.contextPath}/lebi/tradedetail/incomeexcel?userid='+userid+'&bizid='+bizid+'&createtimestart='
...
<body>
  <div class="easyui-panel" title="${internationalConfig.查询条件}">
   <form id="searchForm">
          ...
          <tr>
            <td>
             ...
             <td>
              ...
              <input style="width:138px;" id="userid" name="userid" placeholder="${internationalConfig.用户} ID\ ${internationalConfig.用户名}"
              class="span2"/>
            </td>
            <tr>
            <td>
