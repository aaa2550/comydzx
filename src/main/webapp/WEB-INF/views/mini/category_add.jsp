...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="">
        <div class="Breadcrumbs">
            当前品类<span>${parentCategory.pathTree}</span>
        </div>
        <form id="form" method="post" action="">
            ...
            <table style="width: 100%" class="table table-form">
                ...
                <tr>
                    ...
                    <td>
                        <textarea type="text" name="description" style="width: 300px;height: 100px;"
                               class="easyui-validatebox"  data-options="validType:'maxLength[200]'"></textarea>
