    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            dataGrid = $('#dataGrid')
                    .datagrid(
                            {
                                url: '${pageContext.request.contextPath}/na/lebi/tradedetail/incomesumquery',
...
//                                            str += row.lbsum;
        ...
        function loadsum() {
            ...
            var bizid = $("#bizid").val();
            var url = "/na/lebi/tradedetail/incomesumquerycount";
            $.post(url, {
        ...
        function tradefun(bizid) {
            ...
            parent.iframeTab.init({
                url: '/na/lebi/tradedetail/incomedialog?bizid=' + bizid,
                text: '${internationalConfig.收入明细}'
            });
        }
    </script>
</head>
...
<div class="easyui-layout" data-options="fit : true,border : false">
    <div data-options="bodyCls:'boss_common_scroll',region:'north',title:'${internationalConfig.查询条件}&nbsp;&nbsp;&nbsp;${internationalConfig.时间段}、${internationalConfig.业务线}, ${internationalConfig.至少输入一项}！',border:false,height:'auto'">
        <form id="searchForm">
            <table class="table-more">
                <tr>
                    <td>
                        ${internationalConfig.时间段}：
                        <input type="text" id="createtimestart" name="createtimestart" style="width: 160px"
                               class="easyui-datetimebox" class="easyui-validatebox"/>
                        <input type="text" id="createtimeend" name="createtimeend" style="width: 160px"
                               class="easyui-datetimebox" class="easyui-validatebox"/>
                    </td>
                    <td>
