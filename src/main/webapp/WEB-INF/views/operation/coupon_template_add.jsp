...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#form').form({
            url: '${pageContext.request.contextPath}/coupon_template/add.json',
            onSubmit: function () {
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="">
        <form id="form" method="post"
              action="${pageContext.request.contextPath}/coupon_template/add.json">
            <table class="table table-form" style="width:100%">
                ...
                <tr>
                    ...
                    <td><c:forEach items="${ownerTypes}" var="var">
                        <input name="ownerType" <c:if test="${var.value=='2'}">checked="checked"</c:if> type="radio" value="${var.value}">${var.name}
                    </c:forEach></td>
                        ...
                        <table>
                            <tr style="border-top:0px">
                                <td>${internationalConfig.用户限额}: <input class="easyui-numberbox"
                                                 ...
                                                 type="text" name="userQuota"/>(0<c:if test="${currentLanguage=='en'}"><c:out value=" "/></c:if>${internationalConfig.代表没限制})
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>${internationalConfig.全屏影视会员}: <c:forEach items="${advancedPackageInfos}" var="var">
                                    <input name="advancedRules" type="checkbox" value="${var.duration}">${var.description}
                                </c:forEach>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>${internationalConfig.套餐}: <input name="combinePackageRule" type="checkbox" value="1">${internationalConfig.支持组合套餐}
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    ...
                    <td><label> <textarea name="ext" class="textarea easyui-validatebox txt-middle"></textarea>
                    </label></td>
                </tr>
            </table>
        </form>
