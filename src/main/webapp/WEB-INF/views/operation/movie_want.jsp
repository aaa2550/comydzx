...
<div class="easyui-layout" data-options="fit : true,border : false">
	...
	<div id="toolbar" style="display: none;">
		...
		<a href="javascript:void(0);" class="easyui-linkbutton"
			...
			<a href="javascript:void(0);" class="easyui-linkbutton"
			data-options="iconCls:'pencil_add',plain:true" onclick="exportExcel();">${internationalConfig.导出}<c:if test="${currentLanguage=='en'}"><c:out value=" "/></c:if>UID</a>
	</div>
</body>
<script type="text/javascript">
							...
							columns : [ [
									{
										...
										field : 'updateTime',
										title : '${internationalConfig.预约时间}',
										width : 200,
									}
								 ] ],
							toolbar : '#toolbar',
	...
	function exportExcel() {
	    ...
	    var url = '/movie_want/export/' + batch;
	    //alert(url) ;
	    location.href = url;
	}
