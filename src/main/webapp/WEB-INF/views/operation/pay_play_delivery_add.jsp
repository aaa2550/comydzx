...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/pay_play_delivery/add.json',
			onSubmit : function() {
		...
		<form id="form" method="post"
			...
			<table style="width: 100%" class="table table-form">
				...
				<tr>
					...
					<td><b>PID值：</b><input name="pids" class="easyui-validatebox" data-options="required:true" /></td>
				</tr>
				<tr>
					<th>有效期：</th>
					...
					<td colspan="4">
						至&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="endTime" id="endTime" class="easyui-datebox" data-options="required:true" />
					</td>
				</tr>
				<tr>
					<th>位置1图片：</th>
					<td ><input type="text" id="img1" name="img1"/></td>
					<td>
						<input class="buttoncenter" type="button" value="上传文件" id="img1_btn" />
					</td>
		            <td><div id="img-img1" name="img-img1" ></div></td>
		            <td><b>URL1：</b><input name="link1" id="link1" /></td>
		            <td><b>CMS板块ID：3232</b></td>
				</tr>
				<tr>
					<th>位置2图片：</th>
					<td ><input type="text" id="img2" name="img2"/></td>
					<td>
						<input class="buttoncenter" type="button" value="上传文件" id="img2_btn" />
					</td>
		            <td><div id="img-img2" name="img-img2" ></div></td>
		            <td><b>URL2：</b><input name="link2" id="link2" /></td>
		            <td><b>CMS板块ID：3220</b></td>
				</tr>
				<tr>
					<th>位置3图片：</th>
					<td ><input type="text" id="img3" name="img3"/></td>
					<td>
						<input class="buttoncenter" type="button" value="上传文件" id="img3_btn" />
					</td>
		            <td><div id="img-img3" name="img-img3" ></div></td>
		            <td><b>URL3：</b><input name="link3" id="link3" /></td>
		            <td><b>CMS板块ID：3233</b></td>
				</tr>
				<tr>
					<th>位置4图片：</th>
					<td ><input type="text" id="img4" name="img4"/></td>
					<td>
						<input class="buttoncenter" type="button" value="上传文件" id="img4_btn" />
					</td>
		            <td><div id="img-img4" name="img-img4" ></div></td>
		            <td><b>URL4：</b><input name="link4" id="link4" /></td>
