...
<script type="text/javascript">
							...
							columns : [ [
									{
										...
										field : 'name',
										title : '${internationalConfig.规则名称}',
										width : 100,
									},
									{
										field : 'channel',
										title : '${internationalConfig.销售渠道}',
										width : 80,
	...
	function addFun(id){
		parent.$.modalDialog({
			...
			width :600,
			height :400,
			href : '/rebate/settlement/edit?id='+id,
			buttons : [ {
	...
	function deleteFun(id){
		if(window.confirm("${internationalConfig.确定删除吗}？")){
			$.get("/rebate/channel/delete/"+id+"?type=settlement",function(){
...
<body>
	<div class="easyui-layout" data-options="fit : true,border : false">
		<div data-options="region:'north',title:'${internationalConfig.查询条件}',border:false" style="overflow: hidden; height: 145px">
        <form id="searchForm">
            <table class="table-more" style="display: none;">
				<tr>
				<td ><span>${internationalConfig.规则名称}：</span><input name="name" type="text" class="easyui-validatebox span2"  value="${channel.name }"></td>
				...
				<tr>			
			   	<td ><span>${internationalConfig.生效时间}：</span>  <input type="text" name="effectiveDate"  style="width: 165px"
                                   class="easyui-datebox" class="easyui-validatebox"   /></td>								
					<td ><span>${internationalConfig.申请人}：</span><input type="text"  name="principal"  value="${channel.principal }"     /></td>
