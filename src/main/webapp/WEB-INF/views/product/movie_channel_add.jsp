        ...
        <form id="form" method="post">
            <table style="width: 100%;" class="table table-form">
                ...
                <tr>
					...
					<td><input type="text" name="price" class="easyui-validatebox"
						data-options="required:true,validType:'number'" /></td>
                </tr>
                <tr>
                    <th>${internationalConfig.付费类型}：</th>
                    <td>
                        <!-- <input name="chargeType" type="radio" value="0" checked="checked"/>点播 -->
                        <input name="chargeType" type="radio" value="1" checked="checked"/>${internationalConfig.点播且包月}
                        <input name="chargeType" type="radio" value="2"/>${internationalConfig.包月}
                        <!-- <input name="chargeType" type="radio" value="3"/>免费但TV包月收费 -->
                        <!-- <input name="chargeType" type="radio" value="4"/>包年 -->
                        <!-- <input name="chargeType" type="radio" value="5"/>码流付费 -->
                    </td>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#form').form({
            url: '${pageContext.request.contextPath}/movie_channel/add.json',
            onSubmit: function () {
