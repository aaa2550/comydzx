...
<script type="text/javascript">
    $(function () {
        ...
        $('#form').form({
            url: '/movie/movie_video_update.json',
            onSubmit: function () {
        ...
        <form id="form" method="post">
            ...
            <table style="width: 100%;" class="table table-form">
				...
				<tr>
					...
					<td><input type="text" readonly="readonly" value="${videoListCount}" /><input type=button class="boss-btn" value="${internationalConfig.同步媒资集数}"   onclick="movieVideoSync()"></td>
					<th>${internationalConfig.免费集数}</th>
					<td><input type="text" readonly="readonly" value="${videoFreeCount}" /></td>
				</tr>
				<tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="immediatelyValidate">
					...
					<td>
						<input type="text" id="regularTime" name="regularTime" value="${movieVideoRule.regularTime}"/>
					</td>
                </tr>
            </table>
        </form>
