...
<script type="text/javascript">
  ...
  $(function() {
    dataGrid = $('#dataGrid').datagrid({
      url : '${pageContext.request.contextPath}/sport_live/data_grid.json',
      fit : true,
      fitColumns : true,
      border : false,
      pagination : true,
      ...
      {
        field : 'movieId',
        title : '${internationalConfig.编号}',//直播ID
        width : 60
      },{
        field : 'extendId',
      ...
      {
        field : 'liveTime',
        title : '${internationalConfig.直播开始时间}',
        width : 60
      },
      {
        field : 'liveEndTime',
        title : '${internationalConfig.直播结束时间}',
        width : 60
      },
      {
        field : 'payBeginTime',
      ...
      {
        field : 'itemDesc',
        title : '${internationalConfig.赛事ID}',
        width : 60
      },
      {
        field : 'seasonDesc',
        title : '${internationalConfig.赛季ID}',
        width : 60
      },
      {
        field : 'roundsId',
        title : '${internationalConfig.轮次ID}',
        width : 60
      },
      {
        field : 'homeId',
        title : '${internationalConfig.主队ID}',
        width : 60
      },
      {
        field : 'visitId',
        title : '${internationalConfig.客队ID}',
        width : 60
      },
      {
        field : 'liveStatus',
        title : '${internationalConfig.直播状态}',
        width : 60,
        formatter : function(value) {
          var str = '';
          if("1" == value) {
            str = "${internationalConfig.未开始}";
          }else if("2" == value) {
            str = "${internationalConfig.进行中}";
          }else if("3" == value) {
            str = "${internationalConfig.已结束}";
          }else if("4" == value) {
            str = "${internationalConfig.延期}";
          }else if("5" == value) {
            str = "${internationalConfig.取消}";
          }else{
  ...
  function editFun(id) {
    ...
    parent.$.modalDialog({
      ...
      height : 700,
      resizable : true,
      href : '${pageContext.request.contextPath}/sportlive/show_edit_live.json?movieId=' + id,
      buttons : [ {
      ...
      <form id="searchForm">
        <table class="table-td-four">
          <tr>
            ...
            <td>${internationalConfig.赛季ID}:<input name="sessionId" class="span2" /></td>
          </tr> 
          <tr>
            <td>${internationalConfig.轮次ID}:<input name="roundsId" class="span2" />
            </td>
