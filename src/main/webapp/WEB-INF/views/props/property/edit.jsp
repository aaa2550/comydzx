...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="">
        <form id="form" method="post" action="/props/property/save">
            <input type="hidden" name="id" value="${propsProperty.id}">
            <table style="width: 100%" class="table table-form">
                <tr>
                    <th><b style="color: red">*</b>属性名称：</th>
                    <td>
                        <input name="name" value="${propsProperty.name}" class="span2, easyui-validatebox" data-options="required:true">&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    <th>是否默认：</th>
                    <td>
                        <input type="radio" value="1" ${propsProperty.isDefault==1 ? 'checked':''} name="isDefault">是&nbsp;&nbsp;
                        <input type="radio" value="0" ${propsProperty.isDefault==0 ? 'checked':''} name="isDefault">否&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    <th>排序：</th>
                    <td><input name="no" value="${propsProperty.no}" class="span2, easyui-validatebox">数值越小的排在前面</td>
                </tr>
            </table>
        </form>
    </div>
