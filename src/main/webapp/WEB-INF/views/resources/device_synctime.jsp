        ...
        $('#form').form({
            ...
            success: function (obj) {
                ...
                if (result.code==0) {
                    ...
                    parent.$.messager.alert('${internationalConfig.同步时长结果}', result.msg?result.msg:'${internationalConfig.同步时长失败}', 'error');
                }
            }
        });
    });
	...
	<div data-options="region:'center',border:false" title=""
		...
		<form id="form" method="post"
			...
			<table style="margin-left: 30px; margin-top: 40px">
				<tr>
					<th>${internationalConfig.赋予设备时长}：</th>
					<td><label> <input type="text" name="resourceId"
							...
							<input type="hidden" name="vipType"  value="${vipType}"/>
					</label></td>
				</tr>
			</table>
