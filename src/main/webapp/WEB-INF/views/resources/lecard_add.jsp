			...
			<table style="margin-left: 30px; margin-top: 20px">
				...
				<tr>
                    ...
                    <td>
                        ...
                        <label style="display:inline-block;margin-right:10px;">
                             <input type="radio" value="2" name="applyType">${internationalConfig.兑换码}
                        </label>
                        <label style="display:inline-block;">
                             <input type="radio" value="4" name="applyType">${internationalConfig.超级手机兑换码}
                        </label>
                    </td>
				...
				<tr class="sqme">
					...
					<td><label> <input type="text" name="amount" value="0"
							...
							data-options="min:0,max:10000,precision:0,required:true" />
					</label></td>
				</tr>
					<tr class="sqme">
				...
				<tr class="dhtc" style="display: none;">
					...
					<td><label> <select name="applyPackage"
							style="width: 165px;" id="applyPackage">
								<c:forEach items="${applyPackageList}" var="applyPackage">
								  <c:if test='${!fn:startsWith(applyPackage.key, "4")}'>   
			<option	 value="${applyPackage.key}">${applyPackage.value.packageNameDesc}</option>
								</c:if> 
								</c:forEach>
						</select>
					</label></td>
