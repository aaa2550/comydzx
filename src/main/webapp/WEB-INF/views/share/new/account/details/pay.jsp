...
<div class="easyui-layout" data-options="fit : true,border : false">
    <div data-options="region:'north',title:'${internationalConfig.结算明细}',border:false" style="height: 50px; overflow: hidden;">
        总计 : <font class="price" style="color: red;font-size: 18px">￥ ...</font><a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'brick_add',plain:true" onclick="exportFile();">${internationalConfig.导出数据}</a>
    </div>
