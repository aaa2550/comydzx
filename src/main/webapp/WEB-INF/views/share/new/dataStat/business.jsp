...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            dataGrid = $('#dataGrid').datagrid({
                ...
                columns: [[{
                    ...
                    width: 100,
                    formatter: function (value, row, index) {
                        return "<a target='_blank' href='/dataStat/details/business/list.do?startTime=" + row.startTime + "&endTime=" + row.endTime + "&memberType=" + row.memberType + "&cid=" + row.cid + "'>${internationalConfig.日明细}</a>";
                    }
                }]],
                toolbar: '#toolbar'
            });
        ...
        function exportFile() {
            ...
            var url = '/dataStat/business/export?';
