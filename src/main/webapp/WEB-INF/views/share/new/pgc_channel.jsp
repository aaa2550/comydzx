        ...
        $(function () {
            ...
            dataGrid = $('#dataGrid').datagrid({
                ...
                columns: [[{
                    ...
                    width: 100,
                    formatter: function (value, row, index) {
                        return String.format("<a href='javascript:void(0);' onclick='updateFun({0},{1})' class='easyui-linkbutton' data-options='iconCls:brick_delete,plain:true'>${internationalConfig.修改}</a>", row.id,value);
                    }
                }]],
                toolbar: '#toolbar',
