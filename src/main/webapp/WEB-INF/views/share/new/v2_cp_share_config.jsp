        ...
        $(function () {
            ...
            dataGrid = $('#dataGrid').datagrid({
                ...
                columns: [[{
                    ...
                    width: 200,
                    formatter: function (value, row, index) {
                        var str = $.formatString("<a href='javascript:void(0);' onclick='updateFun({0})' class='propsOperation'>${internationalConfig.修改}</a> | ", row.id);
                        str += $.formatString("<a href='javascript:void(0);' onclick='deleteFun({0});' class='propsOperation'>${internationalConfig.删除}</a>", row.id);
                        return str;
                    }
                }]],
                toolbar: '#toolbar',
