...
<script type="text/javascript">
    $(function () {
        ...
        $('#form').form({
            url: '${pageContext.request.contextPath}/share_pay_config/edit_submit.json',
            onSubmit: function () {
...
<div class="easyui-layout" data-options="fit:true,border:false" style="width: 1000px; height: 650px">
    <div data-options="region:'center',border:true" title="" style="overflow: hidden;">
        <form id="form" method="post">
        	<input type="hidden" value="${sharePayConfig.id}" name="id" />
            <table class="table table-hover table-condensed" style="width: 100%; height: 100%">
                <tr>
                    <th>专辑id</th>
                    <td><input name="albumId" type="text" value="${sharePayConfig.albumId}" readonly="readonly" id="movieId">
                    </td>
                </tr>
                <tr>
                    <th>付费分成时间</th>
                    <td>
                        <input type="text" name="payBeginTime" id="payBeginTime"
                               value="<fmt:formatDate pattern="yyyy-MM-dd" value="${sharePayConfig.payBeginTime}"/>"
                               class="easyui-datebox" style="width:100px"/>
                         ~
                         <input type="text" name="payEndTime" id="payEndTime"
                               value="<fmt:formatDate pattern="yyyy-MM-dd" value="${sharePayConfig.payEndTime}"/>"
                               class="easyui-datebox" style="width:100px"/>
                    </td>
                </tr>
                 <tr>
                    <th>分成单价</th>
                    <td>
                      <input type="text" name="price" id="price" value="${sharePayConfig.price}" />
                    </td>
                </tr>
               ...
               <tr>
                ...
                <tr>
                    <th>付费分成系数</th>
                    <td>
                      <input type="text" name="ratio" id="ratio" value='${sharePayConfig.ratio}' />
                    </td>
                </tr>
                <tr>
                    <th>历史修改记录</th>
                    <td>
                    <div style="position:absolute; height:150px; width: 500px; overflow:auto">
                    	<table>
                    		<thead>
                    			<tr>
                    				<td>开始时间</td>
