							...
							columns : [ [
									...
									},
									{
										...
										formatter : function(value, row, index) {
											var str = '';
											if ($.canModify) {
												str += String.format('<img onclick="modifyFun(\'{0}\');" src="{1}" title="${internationalConfig.修改}"/>', row.id, '${pageContext.request.contextPath}/static/style/images/extjs_icons/pencil.png');
											}

											str += '&nbsp;&nbsp;&nbsp;';
											if ($.canDelete) {
												str += String.format('<img onclick="deleteFun(\'{0}\');" src="{1}" title="${internationalConfig.删除}"/>', row.id, '${pageContext.request.contextPath}/static/style/images/extjs_icons/cancel.png');
											}

											str += '&nbsp;&nbsp;&nbsp;';
											str += String.format('<img onclick="resetPwd(\'{0}\');" src="{1}" title="${internationalConfig.重置密码}"/>', row.id, '${pageContext.request.contextPath}/static/style/images/extjs_icons/bullet_key.png');
											return str;
										}
									}
							] ],
