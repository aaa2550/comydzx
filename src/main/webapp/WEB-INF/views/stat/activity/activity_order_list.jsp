...
<head>
    ...
    <script type="text/javascript">
        ...
        var dataGrid;
        $(function () {
            dataGrid = renderDataGrid('${pageContext.request.contextPath}/tj/activity/order/dataGrid');
        });
        ...
        function exportFile() {
        	...
        	var url = '${pageContext.request.contextPath}/tj/activity/export/orderFile?terminal='+terminal+'&sdate='
        			+ startDate + '&edate='+ endDate + '&event_type='+ event_type;
        	location.href = url;
        }
            ...
            <table class="table table-hover table-condensed">
                ...
                <tr>
                    ...
                    <td>
                     ...
                     <td>    
                        <select name="event_type" style="width: 160px" id="event_type">
                            <option value="-2" selected="selected">全部</option>
                        	<c:forEach var="activityName" items="${activityNameList}">
                        		<option value="${activityName.id}">${activityName.activityName}</option>
                        	</c:forEach>
