...
<script type="text/javascript">
    $(function () {
        ...
        $('#form').form({
            url: '${pageContext.request.contextPath}/tj/channelStat/channel/create',
            onSubmit: function () {
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;">
        <form id="form" method="post" action="${pageContext.request.contextPath}/tj/channelStat/channel/create">
            <table style="margin:5px; margin-top:30px" class="table-hover table-condensed">
                <tr>
                    <th>渠道级别:</th>
                    <td><select id="domainId" name="domainId" title="ex:360,baidu为站外" style="width: 160px" onchange="loadModuleByChannel()">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <span style="color: red; font-weight: bold">
                            (ref=xxx,ref对应的值必须为数字，字母和下划线的组合)
                        </span>
                    </td>
                </tr>
                <tr>
