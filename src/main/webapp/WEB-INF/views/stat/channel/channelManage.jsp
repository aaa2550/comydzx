...
<head>
    ...
    <script type="text/javascript">
        var dataGrid;
        $(function () {
            dataGrid = renderDataGrid('${pageContext.request.contextPath}/tj/channelStat/channel/query');
        });
        ...
        function addFun() {
            parent.$.modalDialog({
                ...
                width: 680,
                height: 300,
                href: '${pageContext.request.contextPath}/tj/channelStat/channel/add',
                buttons: [
                    {
                        text: '添加',
                        handler: function () {
        ...
        function editFun(channelId) {
            parent.$.modalDialog({
                ...
                width: 680,
                height: 300,
                href: '${pageContext.request.contextPath}/tj/channelStat/channel/edit?channelId=' + channelId,
                buttons: [
                    {
                        text: '更新',
                        handler: function () {
        ...
        function deleteFun(channelId) {
            parent.$.messager.confirm('询问', '您是否要删除此信息？', function (b) {
                if (b) {
                    ...
                    $.post('${pageContext.request.contextPath}/tj/channelStat/channel/delete', {
                        channelId: channelId},
                        function (result) {
                            if (result.code == 0) {
        ...
        function searchFun() {
            renderDataGrid('${pageContext.request.contextPath}/tj/channelStat/channel/query?' + $("#searchForm").serialize());
        }
        function cleanFun() {
