...
<script type="text/javascript">
    $(function () {
        ...
        $('#form').form({
            url: '${pageContext.request.contextPath}/xtj/channel/update',
            onSubmit: function () {
        ...
        $("#domainId2").val('${channel.domainId}');
        loadModuleByChannel();
    });

    function loadModuleByChannel() {
        var domainSelect = $("#domainId2");
        var domainId = domainSelect.val();
        var moduleSelect = $("#moduleId2");
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;">
        <form id="form" method="post" action="${pageContext.request.contextPath}/xtj/channel/update">
            <table style="margin:5px; margin-top:30px" class="table-hover table-condensed">
                ...
                <tr>
                    <th>渠道级别:</th>
                    <td><select id="domainId2" name="domainId" title="ex:360,baidu为站外"
                    ...
                    <th>渠道类别:</th>
                    <td><select id="moduleId2" name="moduleId" style="width: 160px">
