...
<head>
    ...
    <script type="text/javascript">
        var dataGrid;
        $(function () {
            dataGrid = renderDataGrid('${pageContext.request.contextPath}/tj/channelStat/clickPv/query');
        });
            ...
            <table class="table table-hover table-condensed">
                ...
                <tr>
                    ...
                    <td><select id="terminal" name="terminal" style="width: 160px" >
							<option value="113" selected>M站</option>
						</select>
					</td>
                    <td>
                    	<input name="channelParameter" style="width: 160px; height: 24px" />
					</td>
                    <td></td>
                    <td></td>
                </tr>
