...
<head>
    ...
    <script type="text/javascript">
        var dataGrid;
        $(function () {
            dataGrid = renderDataGrid('${pageContext.request.contextPath}/tj/channelStat/outside/trendQuery');
        });
        ...
        function searchFun() {
            renderDataGrid('${pageContext.request.contextPath}/tj/channelStat/outside/trendQuery?' + $("#searchForm").serialize());
        }
        function cleanFun() {
        ...
        <form id="searchForm">
            <table class="table table-hover table-condensed">
                ...
                <tr>
                    ...
                    <td>
                        <input name="channelParameter" class="easyui-textbox"/>
                    </td>
                </tr>
            </table>
        </form>
