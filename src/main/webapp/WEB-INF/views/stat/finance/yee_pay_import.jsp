...
<script type="text/javascript">
    $(function () {
        ...
        $('#form').form({
            url: '${pageContext.request.contextPath}/tj/jtStatController/importYeePayFile',
            onSubmit: function () {
        ...
        <form id="form" method="post" enctype="multipart/form-data">
            ...
            <table style="margin:5px; margin-top:30px" class="table-hover table-condensed">
                <tr>
                    <th>导入文件:</th>
                    <td>
                        <input class="easyui-filebox" name="sourceFile" style="width:250px" data-options="prompt:'请选择文件...'">
                    </td>
                </tr>
                <tr></tr>
                <tr>
                    ...
                    <td>
                    <td>
                        <input type="hidden" value="${signnumber}" name="partner"/>
                    </td>
                </tr>
            </table>
        </form>
