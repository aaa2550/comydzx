...
<head>
    ...
    <script type="text/javascript">
        ...
        var dataGrid;
        $(function () {
            dataGrid = renderDataGrid('${pageContext.request.contextPath}/tj/letvPhoneStat/phoneType/dataGrid');
        });
        ...
        function pickMealTypeAndRender(mealType) {
            ...
            var pies = $.map(rows, function (row) {
                return {name: row['phoneType'], y: row[mealType]}
            })
            renderChart(pies, '年数');
        }
