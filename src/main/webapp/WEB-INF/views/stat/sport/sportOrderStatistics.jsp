...
<head>
    ...
    <script type="text/javascript">
        ...
        var dataGrid;
        $(function () {
            dataGrid = renderDataGrid('${pageContext.request.contextPath}/sportsstat/query/ordertype');
        });
        ...
        function pickMealTypeAndRender(mealType) {
            ...
            var pies = $.map(rows, function (row) {
                return {name: row['orderName'], y: row[mealType]}
            })
