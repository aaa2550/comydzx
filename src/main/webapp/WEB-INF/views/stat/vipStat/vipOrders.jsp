...
<head>
   ...
   <script type="text/javascript">
        ...
        var dataGrid;
        $(function () {
            dataGrid = renderDataGrid('${pageContext.request.contextPath}/vipController/query/queryList');
        });
        ...
        function exportExcel() {
        	...
        	var url = '${pageContext.request.contextPath}/vipController/exportConsume?beginDate='+begin + '&endDate=' + end + '&terminal=' + terminal + '&terminal2=' + terminal2 + '&orderpaytype=' + orderpaytype + '&orderpaytype1=' + orderpaytype1 + '&viptype=' + viptype;
        	location.href= url ;
        }
	   	        ...
	   	        series: [{
	   	            ...
	   	            name: '新增订单数',
	   	             data: $.map(rows, function (element) {
							...
							return Number(element['newVipOrders']) ; 
	   	                })
	   	        },
	   	        {
	   	           type: 'column',
	   	           name: '续费订单数',
	               data: $.map(rows, function (element) {
	            	   return Number(element['xfVipOrders']) ; 
	                  })
	          	   },
	          		{
	          		 type: 'spline',
	      	        name: '新增+续费',
	                  data: $.map(rows, function (element) {
	                	  return Number(element['newAndxf']) ; 
	                     })
	             	   }
	             	   ]
	   	    });
    ...
    <div data-options="region:'north',title:'查询条件',border:false"
        ...
        <form id="searchForm">
            <table class="table table-hover table-condensed">
                ...
                <tr>
                    <td>
                        <input name="beginDate" id="begin" class="easyui-datebox" data-options="required:true" validType="TimeCheck" invalidMessage="查询时间范围是60天!!!" value="${start}" style="width: 160px; height: 29px"/>
                    </td>

                    <td>
                        <input name="endDate" id="end" class="easyui-datebox" data-options="required:true" validType="TimeCheck" invalidMessage="查询时间范围是60天!!!" value="${end}" style="width: 160px; height: 29px">
                    </td>
                    <td>
