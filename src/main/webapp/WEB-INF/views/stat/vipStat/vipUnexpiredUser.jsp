...
<head>
	...
	<script src="${pageContext.request.contextPath}/static/lib/highcharts/exporting.js" type="text/javascript"></script>
       <script type="text/javascript">
        ...
        var dataGrid;
        $(function () {
            dataGrid = renderDataGrid('${pageContext.request.contextPath}/vipController/unexpiredUser/unexpiredUserList');
        });
	   	        ...
	   	        series: [
	   	        	{
		   	            ...
		   	            data: $.map(rows, function (element) {
								return Number(element['activeVip']) ; 
		   	                })
		   	        	}
	            ]
	   	    });
