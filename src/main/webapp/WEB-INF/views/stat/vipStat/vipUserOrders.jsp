...
<head>
	...
	<script src="${pageContext.request.contextPath}/static/lib/highcharts/exporting.js" type="text/javascript"></script>
       <script type="text/javascript">
        ...
        var dataGrid;
        $(function () {
            dataGrid = renderDataGrid('${pageContext.request.contextPath}/vipController/userQuery/userQueryList');
        });
        ...
        function exportExcel() {
        	...
        	var url = '${pageContext.request.contextPath}/vipController/exportVipUserExcel?beginDate='+begin + '&endDate=' + end + '&terminal=' + terminal + '&terminal2=' + terminal2 + '&orderpaytype=' + orderpaytype + '&orderpaytype1=' + orderpaytype1 + '&viptype=' + viptype;
        	location.href= url ;
        }
        ...
        <form id="searchForm">
            <table class="table table-hover table-condensed">
                ...
                <tr>
                    ...
                    <td>
                        <input name="endDate" id="end" class="easyui-datebox" data-options="required:true" value="${end}" validType="TimeCheck" invalidMessage="查询时间范围是60天!!!" style="width: 160px; height: 29px">
                    </td>
                    <td>
