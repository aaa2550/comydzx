...
<script type="text/javascript">
	...
	$(function () {
	    ...
	    dataGrid = renderDataGrid('${pageContext.request.contextPath}/tj/statzb/vip_activity_order/dataGrid');
		// dataGrid = renderDataGrid('${pageContext.request.contextPath}/celery/stat/data/stat-zhibiao-vipday-vip_activity_order_user?method=vvvv');
	});
	...
	function exportExcel() {
    	...
    	var url = '${pageContext.request.contextPath}/tj/statzb/vip_activity_order/export?paytype='+paytype+'&sdate='
    			+ sdate + '&edate='+ edate + '&terminal='+ terminal +"&device=" + device;
    	location.href = url;
    }
...
<body>
<!--标题-->
    <div class="w_title"><h3>活跃用户统计</h3></div>
    <form id="searchForm">
    <div style="float: left;height: 100px;width: 95%;margin-left: 10px;"> 
    	<table style="width: 100%"  >
    		...
    		<tr style="height: 48px;border: 1px solid #EBEBEB">
    			<!-- <td width="8%" style="text-align: center;font-size: 15px;border: 1px solid #EBEBEB">终端选择</td>
    			<td width="90%">
    				
    				<input name="terminal" id="terminal" type="radio" value="-2" checked="checked" style="margin-left: 20px;font-size: 15px">全部</input>
    				<input name="terminal" id="terminal" type="radio" value="112" style="margin-left: 20px;font-size: 15px"> PC</input>
    				<input name="terminal" id="terminal" type="radio" value="111" style="margin-left: 20px;font-size: 15px"> TV版</input>
    				<input name="terminal" id="terminal"  type="radio" value="113" style="margin-left: 20px;font-size: 15px">M站</input>
    				<input name="terminal" id="terminal" type="radio" value="47" style="margin-left: 20px;font-size: 15px">Android</input>
 					<input name="terminal" id="terminal" type="radio" value="42" style="margin-left: 20px;font-size: 15px">Iphone</input>
 					<input name="terminal" id="terminal" type="radio" value="41" style="margin-left: 20px;font-size: 15px">Ipad</input>
    			</td> -->
