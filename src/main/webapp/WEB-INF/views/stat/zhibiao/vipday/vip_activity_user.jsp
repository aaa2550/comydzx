...
<script type="text/javascript">
	...
	$(function () {
	    ...
	    dataGrid = renderDataGrid('${pageContext.request.contextPath}/tj/statzb/vip_activity/dataGrid');
	...
	function exportExcel() {
    	...
    	var url = '${pageContext.request.contextPath}/tj/statzb/vip_activity/export?paytype='+paytype+'&sdate='
