...
<head>
    ...
    <style type="text/css">
        ...
        .ks {
            background: url(${pageContext.request.contextPath}/static/style/images/stat/png_tips_02.png) no-repeat 0 0;
            z-index: 10;
            width: 185px;
            height: 51px;
            overflow: hidden;
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            dataGrid = renderDataGrid('${pageContext.request.contextPath}/tj/statzb/vip_retention_cvuv/dataGrid');
        ...
        function exportExcel() {
            ...
            var url = '${pageContext.request.contextPath}/tj/statzb/vip_retention_cvuv/export?paytype=' + paytype + '&sdate='
                    + sdate + '&edate=' + edate + '&terminal=' + terminal + '&device=' + device + '&isnew=' + isnew + '&zhibiao=' + zhibiao + '&expire=' + expire;
            location.href = url;
        }
        ...
        $(function () {
                    $("#terminalid").change(function () {
                        ...
                        if (m == 0) {
                            ...
                            $("#deviceid").append("<option value='0' >其他</option>");
                        } else if (m == 1) {
                            $("#deviceid").empty();
                            $("#deviceid").append("<option value='-2' >全部</option>");
...
<body>
<!--标题-->
<div class="w_title"><h3>留存用户统计</h3></div>
<form id="searchForm">
    <div style="float: left;height: 100px;width: 95%;margin-left: 10px;">
        <table style="width: 100%">
            <tr style="height: 48px;border: 1px solid #EBEBEB">
                <td width="8%" style="text-align: center;background-color: #EDEDED;border: 1px solid #EBEBEB"><span
                        style="text-align: center;font-size: 16px;font-weight:bolder;">高级筛选</span></td>
                <td width="90%" style="text-align: right; " colspan="5">
            ...
            <tr style="height: 48px;border: 1px solid #EBEBEB">
                ...
                <td width="30%" style="padding-left: 20px">
                    <select name="terminal" id="terminalid" style="width: 150px">
                    ...
                    <select name="device" id="deviceid" style="width: 150px">
                        <option value="-2">全部</option>
                    </select>
                </td>

                <td width="8%" style="text-align: center;font-size: 15px;border: 1px solid #EBEBEB">留存日期</td>
                <td width="20%" style="padding-left: 20px">
                    <select name="zhibiao" id="zhibiaoid" style="width: 150px">
                        <option value="1" checked="checked" style="margin-left: 20px;font-size: 15px">次日</option>
                        <option value="3" style="margin-left: 20px;font-size: 15px"> 3日</option>
                        <option value="7" style="margin-left: 20px;font-size: 15px"> 7日</option>
                        <option value="15" style="margin-left: 20px;font-size: 15px"> 15日</option>
                        <option value="30" style="margin-left: 20px;font-size: 15px"> 30日</option>
                    </select>
                </td>

                <td width="8%" style="text-align: center;font-size: 15px;border: 1px solid #EBEBEB;">留存会员状态</td>
                <td width="30%">
                    <!-- <select name="terminal" id="terminalid">
                     <option  value="-2" checked="checked" style="margin-left: 20px;font-size: 15px">全部</option>
                     <option  value="112" style="margin-left: 20px;font-size: 15px"> PC</option>
                     <option  value="111" style="margin-left: 20px;font-size: 15px"> TV版</option>
                     <option  value="113" style="margin-left: 20px;font-size: 15px">M站</option>
                     <option  value="130" style="margin-left: 20px;font-size: 15px">移动App</option>
                 </select> -->
                    <input name="expire" id="expireid" type="radio" value="-2" checked="checked" style="margin-left: 20px;font-size: 15px">全部</input>
                    <input name="expire" id="expireid" type="radio" value="1" style="margin-left: 20px;font-size: 15px"> 是</input>
                    <input name="expire" id="expireid" type="radio" value="0" style="margin-left: 20px;font-size: 15px"> 否</input>
            ...
            <tr style="height: 48px;border: 1px solid #EBEBEB">
                ...
                <td width="50%" colspan="3">
                    ...
                    <a href="javascript:void(0);" onclick="searchFun();" class="easyui-linkbutton"
                       style="background-color:#F0F0F0;padding-left: 10px;padding-right: 15px;float: right;margin-right: 20px"
...
<%-- <div class="f_sj" style="margin-top: 168px">
   <table cellpadding="0" cellspacing="1" border="0">
       <tr>
           <td>
               <dl><dt><span>活跃基数(活跃用户数)</span></dt><dd><i>${vipdaymodel.d_00005}</i></dd></dl>
           </td>
           <td>
               <dl><dt><span>留存会员访问视频CVUV </span></dt><dd><i>${vipdaymodel.d_00006}</i></dd></dl>
           </td>
           <td>
               <dl><dt><span>留存会员观看影片数CV</span></dt><dd><i>${vipdaymodel.d_00008}</i></dd></dl>
           </td>
           <td>
               <dl><dt><span>留存人均播放时长(分钟)</span></dt><dd><i>${vipdaymodel.d_00010}</i></dd></dl>
           </td>
           <td>
               <dl><dt><span>留存次均播放时长(分钟)</span></dt><dd><i>${vipdaymodel.d_00011}</i></dd></dl>
           </td>
       </tr>
   </table>
</div>  --%>
