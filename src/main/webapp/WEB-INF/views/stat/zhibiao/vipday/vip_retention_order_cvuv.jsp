...
<script type="text/javascript">
	...
	$(function () {
	    ...
	    dataGrid = renderDataGrid('${pageContext.request.contextPath}/tj/statzb/vip_retention_order_cvuv/dataGrid');
	...
	function exportExcel() {
    	...
    	var url = '${pageContext.request.contextPath}/tj/statzb/vip_retention_order_cvuv/export?paytype='+paytype+'&sdate='
