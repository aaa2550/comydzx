...
<script type="text/javascript">
	...
	$(function () {
	    ...
	    dataGrid = renderDataGrid('${pageContext.request.contextPath}/tj/statzb/vip_retention_order_user/dataGrid');
	...
	function exportExcel() {
    	...
    	var url = '${pageContext.request.contextPath}/tj/statzb/vip_retention_order_user/export?paytype='+paytype+'&sdate='
